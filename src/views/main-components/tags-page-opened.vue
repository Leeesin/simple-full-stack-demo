        ...
        <div ref="scrollBody"
            ...
            <transition-group name="taglist-moving-animation">
                <Tag class="my-list-tags"
                     ...
                     :color="item.children?(item.children[0].name===currentPageName?'green':'default'):(item.name===currentPageName?'green':'default')">{{ itemTitle(item) }}</Tag>
                <!-- <Tag 
                    type="dot"
                    v-for="(item, index) in pageTagsList" 
                    ref="tagsPageOpened"
